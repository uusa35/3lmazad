...
$(document).ready(function () {
    ...
    $('#options-area_id').ready(function () {
        ...
        return axios.get('api/areas').then(function (r) {
            return r.data;
        }).then(function (data) {
            var name = 'name_' + lang;
            data.areas.map(function (c) {
    ...
    $('#area_id').on('change', function () {
        var areaId = $('.area_id').dropdown('get value');
        $('#options-city_id').html('');
        $('#option-text-val-city_id').text('المدينة');
        axios.get('api/area/' + areaId + '/cities').then(function (res) {
            return res.data;
        }).then(function (data) {
            var name = 'name_' + lang;
            console.log('the cities', data.cities);
            data.cities.map(function (m) {
