...
@section('content')
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" method="post" action="{{ route('backend.field.update',$element->id) }}">
                {{ csrf_field() }}
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="number" maxlength="2" name="order" value="{{ $element->order }}" class="form-control" placeholder="Enter text">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        {{--<div class="col-md-10">--}}
                            {{--<div class="mt-checkbox-list">--}}
                                {{--<label class="mt-checkbox">--}}
                                    {{--<input type="checkbox" name="is_required" disabled value="1" {{ $element->is_required ? 'checked' : null }}> is Required--}}
                                    {{--<span></span>--}}
                                {{--</label>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<div class="col-md-10">--}}
                            {{--<div class="mt-checkbox-list">--}}
                                {{--<label class="mt-checkbox">--}}
                                    {{--<input type="checkbox" name="is_model" disabled value="1" {{ $element->is_model ? 'checked' : null }}> is modal--}}
                                    {{--<span></span>--}}
                                {{--</label>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<div class="col-md-10">--}}
                            {{--<input type="text" name="collection_name" disabled value="{{ $element->collection_name }}" class="form-control" placeholder="Enter text">--}}
                        {{--</div>--}}
                    {{--</div>--}}
