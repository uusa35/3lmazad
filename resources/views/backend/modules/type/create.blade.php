    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase">Create New Type</span>
            </div>
        </div>
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" method="post" action="{{ route('backend.type.store') }}">
                {{ csrf_field() }}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{ Form::select('category_id', $categories->where('parent_id',0)->pluck('name_en','id'),0, ['class' => 'form-control']) }}
                        </div>
                    </div>
