            ...
            <ul class="nav navbar-nav pull-right">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('backend.faq.create') }}">
                                <span class="details"><i class="fa fa-lg fa-plus-circle"></i>Create New Faq</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('backend.aboutus.create') }}">
                                <span class="details"><i class="fa fa-lg fa-plus-circle"></i>Create New Aboutus</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('backend.slider.create') }}">
                                <span class="details"><i class="fa fa-lg fa-plus-circle"></i>Create New Slide</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="{{ route('home') }}">
                                <i class="icon-user"></i> Back To Home page</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ url('backend/translations') }}">
                                <i class="icon-lock"></i> Translations </a>
                        </li>
                        <li>
                            <a href="{{ url('/logout') }}"
