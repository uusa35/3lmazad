...
<head>
    ...
    <title> Contactus | {{ config('app.name') }} | {{ $request['subject'] }} </title>
    <style type="text/css">
        body {
                                                            ...
                                                            <td>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable'
                                                                        ...
                                                                        <hr>
                                                                        <h2 style="font-size: 20px;">{!! ucfirst($request['subject'] ) !!}</h2>
                                                                        <br>
                                                                        <h5>name : {!! $request['name'] !!} </h5>
                                                                        <h5>title : {!! $request['subject'] !!} </h5>
                                                                        <h5>phone : {!! $request['phone'] !!} </h5>
                                                                        <h5>email : {!! $request['email'] !!} </h5>
                                                                        </br>

                                                                        <p class="pElement">{!! $request['subject'] !!}
                                                                            .</p>
                                                                        <hr/>
                                                                        <p>
                                                                            <small>{!! $request['name'] !!}
