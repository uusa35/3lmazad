    ...
    <div class="product-preview-wrapper">
        <div class="product-preview">
            <div class="product-preview__image">
                ...
                @endif
                <a href="{{ route(request()->segment(1).'.show',$element->id) }}"><img
            ...
            <div class="product-preview__info text-center">
                ...
                <div class="product-preview__info__title">
                    <h2><a href="{{ route(request()->segment(1).'.show',$element->id) }}">{{ str_limit($element->title,'50','..') }}</a></h2>
                </div>
                ...
                <div class="product-preview__info__description">
                    <p>{!! str_limit($element->body,500,'<a href="'.route(request()->segment(1).'.show',$element->id).'">..more</more>') !!}
                        .</p>
                </div>
