        ...
        <div class="product-preview">
            <div class="product-preview__image">
                ...
                <a href="{{ route('user.show',$element->id) }}"><img
                            src="{{ asset('storage/uploads/images/thumbnail/'.$element->user_meta->logo) }}"
                            alt=""/></a></div>
            <div class="product-preview__info text-center">
                ...
                @if(!empty($element->user_meta->establishment_year))
                    <div class="price-box">Since : {{  $element->user_meta->establishment_year }}</div>
                @endif
                <div class="product-preview__info__description">
                    <p>{!! str_limit($element->user_meta->description,70,'...') !!}
                        <a href="{{ route('user.show',$element->id) }}">..more</a>
                    </p>
                </div>
