        ...
        <form class="form-horizontal" method="POST" id="ad_create"
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control tooltip-message" name="mobile" value="{{ $element->meta->mobile }}"
                    ...
                    <div class="col-sm-9">
                        <select id="area_id" name="area_id" class="form-control">
                            ...
                            @foreach($allAreas as $area)
                                <option value="{{ $area->id }}" {{ $element->area_id === $area->id ? 'selected' : null }}>{{ $area->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" name="address" value="{{ $element->meta->address }}"
