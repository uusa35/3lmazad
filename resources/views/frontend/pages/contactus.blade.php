    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--maps-area start-->
                @if(!is_null($element->latitude) && !is_null($element->longitude))
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <!-- Map area -->
                            <div class="map-area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-12 col-sm-12">
                            ...
                            <p>
                                ...
                                @endif
                                @if(!is_null($element->phone) && trim($element->phone))
                                    <span class="glyphicon glyphicon-earphone"></span> {{ $element->phone }}<br/>
                                @endif
                                @if(!is_null($element->mobile) && trim($element->mobile))
                                    <span class="glyphicon glyphicon-phone"></span> {{ $element->mobile }}<br/>
                                @endif
                                @if(!is_null($element->email) && $element->email)
